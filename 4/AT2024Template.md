...
2. **Название**: Создание нового проекта
...
<a name="resource-plan"></a>
1. **Название**: Составление ресурсного плана
...
<a name="employee-allocation"></a>
3. **Название**: Аллокация сотрудников
...
<a name="forse-allocation"></a>
4. **Название**: Вынужденная аллокация
...
<a name="temporary-allocation"></a>
5. **Название**: Временное выделение сотрудников
